import { AnyObject, EmptyObject, AnyConstructor, AnyConcreteConstructor } from '@system/types/utils';
...
> extends foundry.abstract.TypeDataModel<TSchema, TParent, TBaseData, TDerivedData> {}
...
> = TMix & TBase & (new(...args: any[]) => InstanceType<TMix> & InstanceType<TBase>);

type MixinFunc<
    TBase extends typeof foundry.abstract.TypeDataModel<any, any, any, any> = typeof foundry.abstract.TypeDataModel<any, any, any, any>,
...
export function DataModelMixin<
    TSchema extends foundry.data.fields.DataSchema = foundry.data.fields.DataSchema,
    TParent extends foundry.abstract.Document.Any = foundry.abstract.Document.Any,
    TBaseData extends AnyObject = EmptyObject,
    TDerivedData extends AnyObject = EmptyObject,
>(
    ...mixins: MixinFunc[]
