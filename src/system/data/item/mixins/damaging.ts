...
export type DamagingItemDataSchema = DataSchema<typeof SCHEMA>;
export type DamagingItemData =
    foundry.data.fields.SchemaField.InitializedData<DamagingItemDataSchema>;
