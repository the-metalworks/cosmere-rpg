...
export type RelationshipsItemDataSchema = DataSchema<typeof SCHEMA>;
export type RelationshipsItemData =
    foundry.data.fields.SchemaField.InitializedData<RelationshipsItemDataSchema>;

/**
 * Mixin for items to track relationships with other items.
 * For example, a talent will have a relationship with its path.
 */
export function RelationshipsMixin<
