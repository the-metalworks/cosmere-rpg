...
export type InferInitializedType<
    TField extends foundry.data.fields.DataField.Any,
> =
...
export type InferPersistedType<
    TField extends foundry.data.fields.DataField.Any,
> =
    TField extends foundry.data.fields.DataField<
        any,
...
export type DataSchemaInitializedType<
    TSchema extends foundry.data.fields.DataSchema | undefined,
